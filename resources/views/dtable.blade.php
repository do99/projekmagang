                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div align="left">
                                    <button type="button" name="create_record" id="create_record" class="btn btn-success mb-4"> <a class="text-decoration-none text-white " href="input"><i class="bi bi-person-plus"></i>  ADD</a></button>
